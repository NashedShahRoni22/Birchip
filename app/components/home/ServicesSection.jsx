        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            <div key={index} className="group relative h-full flex">
              ...
              {/* Added flex here */}
              {/* Minimal Card */}
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/30 shadow-sm hover:shadow-md transition-all duration-300 flex-1 flex flex-col">
                {" "}
                ...
                <div className="relative flex flex-col flex-1 z-10">
                  ...
                  <Link
                    href={service.link}
                    className="inline-flex justify-center items-center gap-2 bg-gradient-to-r from-[#B63D5E] to-[#603C59] px-6 py-3 rounded-xl font-semibold text-white transition-colors duration-300 hover:from-[#603C59] hover:to-[#B63D5E] group/button"
                  >
